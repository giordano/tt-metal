...
def DetectionModel(device, x, state_dict):
    ...
    x, out_h, out_w = Conv(device, x, state_dict, "model.0", 3, 16, 3, 2, 1, act_block_h=True)
    ...
    x, out_h, out_w = Conv(device, x, state_dict, "model.1", 16, 32, 3, 2, 1, act_block_h=True)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.2", 32, 32, n=1, shortcut=True, act_block_h=True)
    ...
    x, out_h, out_w = Conv(device, x, state_dict, "model.3", 32, 64, 3, 2, 1)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.4", 64, 64, n=2, shortcut=True, bfloat8=True)
    ...
    x, out_h, out_w = Conv(device, x, state_dict, "model.5", 64, 128, 3, 2, 1, block_shard=True, bfloat8=False)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.6", 128, 128, n=2, shortcut=True, block_shard=True)
    ...
    x, out_h, out_w = Conv(device, x, state_dict, "model.7", 128, 256, 3, 2, 1, block_shard=True)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.8", 256, 256, n=1, shortcut=True, bfloat8=True)
    ...
    x, out_h, out_w = SPPF(device, x, state_dict, "model.9", 256, 256)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.12", 384, 128, n=1, shortcut=False, bfloat8=True)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.15", 192, 64, n=1, shortcut=False)
    ...
    x, out_h, out_w = Conv(device, x, state_dict, "model.16", 64, 64, 3, 2, 1)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.18", 192, 128, n=1, shortcut=False, bfloat8=True)
    ...
    x, out_h, out_w = Conv(device, x, state_dict, "model.19", 128, 128, 3, 2, 1, block_shard=True)
    ...
    x, out_h, out_w = C2f(device, x, state_dict, "model.21", 384, 256, n=1, shortcut=False, bfloat8=True)
    ...
    x = Detect(device, x, state_dict, "model.22", nc=80, ch=(64, 128, 256))

    return x


def YOLOv8n(device, x, state_dict):
