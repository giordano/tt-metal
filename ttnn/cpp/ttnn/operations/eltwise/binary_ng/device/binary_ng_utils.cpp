...
OpConfig::OpConfig(BinaryOpType binary_op_type, bool is_sfpu_op) {
    ...
    switch (binary_op_type) {
        ...
        case BinaryOpType::DIV:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::DIV;
            } else {
                fpu_binary_op = FpuBinaryOp::MUL;
        ...
        case BinaryOpType::RSUB:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::RSUB;
            } else {
        ...
        case BinaryOpType::BITWISE_AND:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::BITWISE_AND;
            } else {
        ...
        case BinaryOpType::BITWISE_OR:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::BITWISE_OR;
            } else {
                TT_THROW("Unsupported binary op for FPU {}", binary_op_type);
            }
            break;
        case BinaryOpType::BITWISE_XOR:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::BITWISE_XOR;
            } else {
                TT_THROW("Unsupported binary op for FPU {}", binary_op_type);
            }
            break;
        case BinaryOpType::LEFT_SHIFT:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::LEFT_SHIFT;
            } else {
                TT_THROW("Unsupported binary op for FPU {}", binary_op_type);
            }
            break;
        case BinaryOpType::RIGHT_SHIFT:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::RIGHT_SHIFT;
            } else {
                TT_THROW("Unsupported binary op for FPU {}", binary_op_type);
            }
            break;
        case BinaryOpType::POWER:
            if (is_sfpu_op) {
                sfpu_binary_op = SfpuBinaryOp::POWER;
            } else {
                TT_THROW("Unsupported binary op for FPU {}", binary_op_type);
            }
            break;
