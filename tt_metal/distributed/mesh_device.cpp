...
// Light Metal
void MeshDevice::light_metal_begin_capture() {
    TT_THROW("light_metal_begin_capture() is not supported on MeshDevice - use individual devices instead");
    reference_device()->light_metal_begin_capture();
}
std::vector<uint8_t> MeshDevice::light_metal_end_capture() {
    TT_THROW("light_metal_end_capture() is not supported on MeshDevice - use individual devices instead");
    return reference_device()->light_metal_end_capture();
}
